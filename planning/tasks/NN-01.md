# NN-01 — Module и parameter trees
...
## Реализация
Структура параметров/буферов, train/eval, freeze, shared/tied weights, tree flatten/unflatten.

## Приёмка
Shared parameter не удваивается в optimizer; buffer state не обучается случайно.
...
Каталог `evidence/runs/nn-01/`: `run.json` с revision/toolchain/hardware/командами; неизменённые stdout/stderr; тестовый отчёт; численные результаты, если применимо; review note.
