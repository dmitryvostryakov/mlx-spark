# PKG-04 — Полный single-Spark release audit

**Фаза:** single_spark · **Владелец:** Sol · **Reviewer:** Luna · **Статус:** todo

## Входные условия
Зависимости: PKG-03, TRAIN-05, QTZ-04, VIS-04, MTP-04, PERF-05, FND-07. Статус зависимости `done` действителен только с evidence и review.
Обязательный контекст: `AGENTS.md`, `CONTEXT.md`, `handoff/AGENT_PROTOCOL.md`, применимая спецификация из `docs/`.

## Реализация
Collect gate evidence for exact API parity, Qwen text/training/quant/vision/MTP, install, performance, security.

## Приёмка
check_gate проходит на настоящем evidence; skipped/unrun/fixture никогда не засчитываются.
...
Каталог `evidence/runs/pkg-04/`: `run.json` с revision/toolchain/hardware/командами; неизменённые stdout/stderr; тестовый отчёт; численные результаты, если применимо; review note.
