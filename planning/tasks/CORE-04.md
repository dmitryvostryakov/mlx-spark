# CORE-04 — Элементные операции и reductions

**Фаза:** single_spark · **Владелец:** Sol · **Reviewer:** Luna · **Статус:** todo

## Входные условия
Зависимости: CORE-03. Статус зависимости `done` действителен только с evidence и review.
Обязательный контекст: `AGENTS.md`, `CONTEXT.md`, `handoff/AGENT_PROTOCOL.md`, применимая спецификация из `docs/`.

## Реализация
Арифметика, transcendental, NaN/Inf, reductions, накопление в согласованной точности, axis tuples и empty reductions.

## Приёмка
CPU/CUDA parity и stress NaN/Inf; compiled/eager должны совпадать в зарегистрированных допусках.
...
Каталог `evidence/runs/core-04/`: `run.json` с revision/toolchain/hardware/командами; неизменённые stdout/stderr; тестовый отчёт; численные результаты, если применимо; review note.
